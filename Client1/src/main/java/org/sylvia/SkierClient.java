...
public class SkierClient {
    ...
    public static void main(String[] args) throws InterruptedException, IOException {
        ...
        System.out.println(String.format("Wall time for all 200k requests: %,d ms", duration));
        System.out.println(String.format("Actual throughput: %,.2f RequestsPerSecond", throughput));
